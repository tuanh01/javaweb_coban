...
@WebServlet("/ShareVideoLikeServlet")
public class ShareVideoLikeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if(videoid == null) {
				...
				email.setFrom("trandinhthien0969@gmail.com");
				email.setFromPassword("thiendaychangsoai0969");
				...
				sb.append("Please click the link ").append(String.format("<a href='http://www.haihaylam.com/clip-hai-moi/dinh-cao-am-nhac-la-day-hai-hay-vo-doi-843.html'>View Video</a>", videoid));
